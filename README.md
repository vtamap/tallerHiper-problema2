...
```
cd existing_repo
git remote add origin https://gitlab.com/evillonl/todolistapi.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/evillonl/todolistapi/-/settings/integrations)
